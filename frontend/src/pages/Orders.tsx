  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-40 bg-manchester-black min-h-screen">
        ...
        <span className="text-white/20 text-xs tracking-widest font-bold uppercase">Cargando tu historial...</span>
      </div>
    );
  }
    ...
    <div className="pt-32 pb-24 bg-manchester-black min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <p className="text-white/40 text-sm tracking-wide uppercase">Historial de tus compras exclusivas en Manchester.</p>
        </div>
        ...
        {orders.length === 0 ? (
          <div className="text-center py-20 border border-dashed border-white/10 rounded-3xl">
            ...
            <p className="text-white/40 text-sm mb-8">Tus compras aparecerán aquí una vez que realices tu primer pedido.</p>
